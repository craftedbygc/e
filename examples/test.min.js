...
function () {
  ...
  _createClass(Foo, [{
    ...
    value: function init() {
      E.bindAll(this);
      E.on('resize', window, function (e) {
        return console.log('window resized!');
      });
      E.on('click', btn, this.eventHandler);
      E.on('click', btn2, this.offHandler);
      E.on('click', '#btnone', this.one, {
        once: true
      });
      E.delegate('click', '#btn3', this.onceHandler);
      E.delegate('click', '.deep', this.delegateHandler);
      E.on('mouseenter', document.querySelectorAll('.nodelist'), function () {
        return console.log('nodelist');
      });
      E.on('mouseenter', _toConsumableArray(document.querySelectorAll('.nodelist')), function () {
        return console.log('nodelist array');
      });
      ...
      E.delegate('click', 'button, h2', function () {
        return console.log('qs example');
      }); // Event bus example
    ...
    */
    ...
    value: function on(event, el, callback, options) {
      if (typeof el === 'function' && callback === undefined) {
        Object(_utils__WEBPACK_IMPORTED_MODULE_1__["makeBusStack"])(event);
        _utils__WEBPACK_IMPORTED_MODULE_1__["listeners"][event].push(el);
        return;
      }
      ...
      for (var i = 0; i < events.length; i++) {
        ...
        el = Object(_utils__WEBPACK_IMPORTED_MODULE_1__["maybeRunQuerySelector"])(el);
    ...
    value: function off(event, el, callback) {
      if (el === undefined) {
        _utils__WEBPACK_IMPORTED_MODULE_1__["listeners"][event] = [];
        return;
      }
      ...
      if (typeof el === 'function') {
        ...
        for (var i = 0; i < _utils__WEBPACK_IMPORTED_MODULE_1__["listeners"][event].length; i++) {
          if (_utils__WEBPACK_IMPORTED_MODULE_1__["listeners"][event][i] === el) {
            _utils__WEBPACK_IMPORTED_MODULE_1__["listeners"][event].splice(i, 1);
          }
        }
      ...
      for (var _i = 0; _i < events.length; _i++) {
        var map = _utils__WEBPACK_IMPORTED_MODULE_1__["eventTypes"][events[_i]];

        if (map !== undefined) {
          map.remove(el, callback);

          if (map.size === 0) {
            delete _utils__WEBPACK_IMPORTED_MODULE_1__["eventTypes"][events[_i]];
            document.removeEventListener(events[_i], _utils__WEBPACK_IMPORTED_MODULE_1__["handleDelegation"]);
            continue;
          }
        }

        if (el.removeEventListener !== undefined) {
          el.removeEventListener(events[_i], callback);
          continue;
        }
        ...
        for (var n = 0; n < el.length; n++) {
          el[n].removeEventListener(events[_i], callback);
        }
      }
    }
    /**
    ...
    value: function emit(event) {
      ...
      Object(_utils__WEBPACK_IMPORTED_MODULE_1__["triggerBus"])(event, args);
    }
    /**
    ...
    value: function debugDelegated() {
      return Object(_utils__WEBPACK_IMPORTED_MODULE_1__["clone"])(_utils__WEBPACK_IMPORTED_MODULE_1__["eventTypes"]);
    }
    /**
    ...
    value: function debugBus() {
      return Object(_utils__WEBPACK_IMPORTED_MODULE_1__["clone"])(_utils__WEBPACK_IMPORTED_MODULE_1__["listeners"]);
    }
  }]);
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: eventTypes, listeners, nonBubblers, makeBusStack, triggerBus, maybeRunQuerySelector, handleDelegation, clone */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "nonBubblers", function() { return nonBubblers; });
...
var nonBubblers = ['mouseenter', 'mouseleave'];
/**
