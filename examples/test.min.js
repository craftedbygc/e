  ...
  _createClass(E, [{
    ...
    value: function on(event, el, callback) {
      ...
      for (var i = 0; i < events.length; i++) {
        ...
        for (var _i = 0; _i < el.length; _i++) {
          el[_i].addEventListener(events[_i], callback);
        }
      }
    }
    /**
    ...
    value: function off(event, el, callback) {
      ...
      for (var _i2 = 0; _i2 < events.length; _i2++) {
        var map = _utils__WEBPACK_IMPORTED_MODULE_1__["eventTypes"][events[_i2]];

        if (map !== undefined) {
          map.remove(el, callback);

          if (map.size === 0) {
            delete _utils__WEBPACK_IMPORTED_MODULE_1__["eventTypes"][events[_i2]];
            document.removeEventListener(events[_i2], _utils__WEBPACK_IMPORTED_MODULE_1__["handleDelegation"]);
            continue;
          }
        }

        if (el.removeEventListener !== undefined) {
          el.removeEventListener(events[_i2], callback);
          continue;
        }
        ...
        for (var _i3 = 0; _i3 < el.length; _i3++) {
          el[_i3].removeEventListener(events[_i3], callback);
        }
      }
    }
    /**
