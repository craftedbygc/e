...
function () {
  ...
  function e() {
    ...
    _handleDelegation.set(this, {
      ...
      value: function value(e) {
        var matches = _classPrivateFieldGet(_this, _eventTypes)[e.type].matches(e.target);
    ...
    _classPrivateMethodGet(this, _polyfill, _polyfill2).call(this);
  }
  /**
  ...
  _createClass(e, [{
    ...
    value: function delegate(event, _delegate, callback) {
      var map = _classPrivateFieldGet(this, _eventTypes)[name];
    ...
    key: "emit",
    value: function emit(event, el) {
      if (el.nodeType && el.nodeType === 1) {
        _classPrivateMethodGet(this, _triggerEvent, _triggerEvent2).call(this, event, el);
      ...
      for (var i = 0; i < el.length; i++) {
        _classPrivateMethodGet(this, _triggerEvent, _triggerEvent2).call(this, event, el[i]);
      }
    }
  }]);
...
var _triggerEvent = new WeakSet();

var _polyfill = new WeakSet();

var _maybeRunQuerySelector2 = function _maybeRunQuerySelector2(el) {
  return typeof el === 'string' ? document.querySelectorAll(el) : el;
};

var _triggerEvent2 = function _triggerEvent2(event, el) {
...
var _polyfill2 = function _polyfill2() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _e__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./e */ "./src/e.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var E = new _e__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
module.exports = __webpack_require__(/*! C:\wamp64\www\gc\e\src\test.js */"./src/test.js");
