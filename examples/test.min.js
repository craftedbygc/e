...
var busTestBtn = document.getElementById('bus-test');
...
function () {
  function Foo() {
    ...
    _defineProperty(this, "listener", function () {
      console.log('Triggered via the event bus!', _this);
    });
  ...
  _createClass(Foo, [{
    ...
    value: function init() {
      ...
      E.on('click', 'div .deep', this.onceHandler); // Event bus example
  ...
  _createClass(e, [{
    ...
    value: function emit(event, el) {
      if (el === undefined) {
        if (_classPrivateFieldGet(this, _listeners)[event]) {
          for (var i = 0; i < _classPrivateFieldGet(this, _listeners)[event].length; i++) {
            _classPrivateFieldGet(this, _listeners)[event][i]();
          }
        }
      ...
      for (var _i = 0; _i < el.length; _i++) {
        _classPrivateMethodGet(this, _triggerEvent, _triggerEvent2).call(this, event, el[_i]);
      }
    }
  }]);
...
module.exports = __webpack_require__(/*! C:\wamp64\www\e\examples\test.js */"./examples/test.js");
