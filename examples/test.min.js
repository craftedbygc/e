    ...
    value: function off(event, el, callback) {
      ...
      for (var i = 0; i < events.length; i++) {
        ...
        if (typeof el === 'function') {
          Object(_utils__WEBPACK_IMPORTED_MODULE_1__["makeBusStack"])(events[i]);

          for (var _i2 = 0; _i2 < _utils__WEBPACK_IMPORTED_MODULE_1__["listeners"][events[_i2]].length; _i2++) {
            if (_utils__WEBPACK_IMPORTED_MODULE_1__["listeners"][events[_i2]][_i2] === el) {
              _utils__WEBPACK_IMPORTED_MODULE_1__["listeners"][events[_i2]].splice(_i2, 1);
            }
          }
